...
*/
public class MaxGoofSort extends BogoSorting {
    ...
    public void runSort(int[] array, int currentLength, int bucketCount) {
        if (!isArraySorted(array, currentLength)) {
            ...
            for (int i = 0; i < currentLength; i++) Writes.write(array, i, max, delay, true, false);
            while (!finalized) {
                ...
                if (isArraySorted(array, currentLength)) finalized = isAnagram(array, init, currentLength);
            }
        }
    }
}
