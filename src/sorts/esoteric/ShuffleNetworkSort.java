...
public final class ShuffleNetworkSort extends BogoSorting {
    ...
    public ShuffleNetworkSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Shuffle as Network");
        ...
        this.setQuestion("Enter shuffle:\n1: Random\n2: Reversed\n3: Almost Sorted\n4: Scrambled End\n5: Scrambled Start\n6: Both Sides Scrambled\n7: Low Disparity\n8: Scrambled Odds\n9: Final Merge\n10: Real Final Merge\n11: Sawtooth\n12: Real Sawtooth\n13: Scrambled Back Half\n14: Partitioned\n15: Quick Partitions\n16: Evens Up, Odds Down\n17: Evens Reversed\n18: Final Radix\n19: Recursive Final Radix\n20: Binary Search Tree\n21: Logpile\n22: Heap\n23: Circle Pass\n24: Final Pairwise\n25: Recursive Reversal\n26: Triangular\n27: Quick Killer\n28: Grail Killer\n29: Shuffle Killer\n(Default is 1)", 1);
    }
    ...
    protected void initializeNetwork(int[] array, int currentLen, int type) {
        ...
        // Logpile (requires double invert)
        if (type == 21) {
            int[] temp = new int[currentLen];
