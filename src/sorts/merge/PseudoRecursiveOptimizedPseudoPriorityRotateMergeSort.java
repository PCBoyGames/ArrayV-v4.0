...
*/
public class PseudoRecursiveOptimizedPseudoPriorityRotateMergeSort extends OptimizedPseudoPriorityRotateMergeSort {

    ArrayList<int[]> offering;
    int offeringIndex;

    public PseudoRecursiveOptimizedPseudoPriorityRotateMergeSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Pseudo-Recursive Optimized Pseudo-Priority Rotate Merge");
        this.setRunAllSortsName("Pseudo-Recursive Optimized Pseudo-Priority Rotate Merge Sort");
        this.setRunSortName("Pseudo-Recursive Optimized Pseudo-Priority Rotate Mergesort");
    ...
    public void prOPPRM(int[] array, int start, int end) {
        offeringIndex = 0;
