...
*/
public class SelectionWeaveSortHigh extends MadhouseTools {

    int lastGap = 0;

    public SelectionWeaveSortHigh(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Selection Weave (High Prime)");
        this.setRunAllSortsName("Selection Weave Sort (High Prime)");
        this.setRunSortName("Selection Weavesort (High Prime)");
