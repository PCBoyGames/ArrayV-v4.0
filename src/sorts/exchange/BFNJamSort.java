...
*/
public class BFNJamSort extends MadhouseTools {
    public BFNJamSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Best For N Jam");
        this.setRunAllSortsName("Best For N Jam Sort");
        this.setRunSortName("Best For N Jamsort");
