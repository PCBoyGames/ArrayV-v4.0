...
*/
public class StableMidpointPartitionSort extends Sort {

    boolean inlow;
    boolean inhigh;

    public StableMidpointPartitionSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Stable MPartition");
        this.setRunAllSortsName("Stable Midpoint Partition Sort");
        this.setRunSortName("Stable Midpoint Partitionsort");
