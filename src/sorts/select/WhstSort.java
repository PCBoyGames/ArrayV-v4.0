...
*/
final public class WhstSort extends MadhouseTools {
    public WhstSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Whst");
        this.setRunAllSortsName("Whst Sort");
        this.setRunSortName("Whstsort");
            ...
            while (checks) {
                ...
                while (swapshere) {
                    ...
                    for (int i = 0; i < len; i++) {
                        ...
                        Highlights.clearAllMarks();
                        if (sel != i) Writes.insert(array, sel, i, 0.05, swapshere = (checks = true), false);
                    }
                    len -= dims[0];
                }
