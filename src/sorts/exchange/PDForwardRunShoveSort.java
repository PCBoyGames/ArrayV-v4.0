...
*/
public class PDForwardRunShoveSort extends MadhouseTools {
    public PDForwardRunShoveSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Pattern-Defeating Forward Run Shove");
        this.setRunAllSortsName("Pattern-Defeating Forward Run Shove Sort");
        this.setRunSortName("Pattern-Defeating Forward Run Shovesort");
