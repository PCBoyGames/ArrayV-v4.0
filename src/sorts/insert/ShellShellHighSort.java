...
*/
public class ShellShellHighSort extends MadhouseTools {
    public ShellShellHighSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Shell Shell (High Prime)");
        this.setRunAllSortsName("Shell Shell Sort (High Prime)");
        this.setRunSortName("Shell Shellsort (High Prime)");
