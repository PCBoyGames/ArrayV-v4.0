...
public class SmoothSortII extends Sort {

    public SmoothSortII(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Smooth II");
        this.setRunAllSortsName("Smooth Sort II");
        this.setRunSortName("Smoothsort II");
