...
*/
public class OOPSMidpointPartitionSort extends Sort {

    boolean inlow;
    boolean inhigh;

    public OOPSMidpointPartitionSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("OopsMPartition");
        this.setRunAllSortsName("Out of Place Stable Midpoint Partition Sort");
        this.setRunSortName("OOP Stable Midpoint Partitionsort");
