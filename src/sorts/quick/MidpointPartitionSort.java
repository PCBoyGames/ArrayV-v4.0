...
*/
public class MidpointPartitionSort extends Sort {
    public MidpointPartitionSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("MPartition");
        this.setRunAllSortsName("Midpoint Partition Sort");
        this.setRunSortName("Midpoint Partitionsort");
